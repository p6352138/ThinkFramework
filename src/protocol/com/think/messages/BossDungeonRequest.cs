...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class BossDungeonRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("BossDungeonRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("BossDungeonRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",DungeonId: ");
      sb.Append(DungeonId);
