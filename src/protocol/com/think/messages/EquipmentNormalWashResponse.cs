...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class EquipmentNormalWashResponse : TBase
  {
    ...
    public EquipmentNormalWashResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("EquipmentNormalWashResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("EquipmentNormalWashResponse(");
