...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class FarmlandOreRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("FarmlandOreRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("FarmlandOreRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",City_id: ");
      sb.Append(City_id);
