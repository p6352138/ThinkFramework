...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class GVE_DissolutionResponse : TBase
  {
    ...
    public GVE_DissolutionResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("GVE_DissolutionResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("GVE_DissolutionResponse(");
