...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class GVGHarmTargetResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("GVGHarmTargetResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("GVGHarmTargetResponse(");
