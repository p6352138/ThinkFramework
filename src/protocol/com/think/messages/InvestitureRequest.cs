...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class InvestitureRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("InvestitureRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("InvestitureRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
