...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class NewCrossServerKingsFightLogResponse : TBase
  {
    ...
    public NewCrossServerKingsFightLogResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("NewCrossServerKingsFightLogResponse");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("NewCrossServerKingsFightLogResponse(");
