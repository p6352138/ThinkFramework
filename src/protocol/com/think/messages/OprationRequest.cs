...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class OprationRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("OprationRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("OprationRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
