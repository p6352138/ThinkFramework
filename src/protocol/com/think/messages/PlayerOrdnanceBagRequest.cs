...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class PlayerOrdnanceBagRequest : TBase
  {
    private byte _type;
    ...
    public PlayerOrdnanceBagRequest() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("PlayerOrdnanceBagRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("PlayerOrdnanceBagRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",GeneralId: ");
      sb.Append(GeneralId);
