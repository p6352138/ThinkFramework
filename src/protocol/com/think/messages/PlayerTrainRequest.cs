...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class PlayerTrainRequest : TBase
  {
    private byte _type;
    private byte _site;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("PlayerTrainRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("PlayerTrainRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",Site: ");
      sb.Append(Site);
