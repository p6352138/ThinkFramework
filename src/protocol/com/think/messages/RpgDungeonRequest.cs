...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class RpgDungeonRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("RpgDungeonRequest");
      ...
      if (__isset.action_id) {
        field.Name = "action_id";
        field.Type = TType.I32;
        field.ID = 10;
        oprot.WriteFieldBegin(field);
        oprot.WriteI32(Action_id);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("RpgDungeonRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",DungeonId: ");
      sb.Append(DungeonId);
