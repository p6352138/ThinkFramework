...
namespace com.think.messages
{
  ...
  [Serializable]
  public partial class ThroughtDungeonRequest : TBase
  {
    private byte _type;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ThroughtDungeonRequest");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("ThroughtDungeonRequest(");
      sb.Append("Type: ");
      sb.Append(Type);
      sb.Append(",DungeonId: ");
      sb.Append(DungeonId);
